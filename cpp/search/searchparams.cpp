...
SearchParams::SearchParams()
  :winLossUtilityFactor(1.0),
   ...
   fpuReductionMax(0.2),
   fpuLossProp(0.0),
   weakGroupUtilityLambda(0.0),
   weakGroupReplyBlendWeight(2.0),
   weakGroupReplyMode(1),
   weakGroupReplyAlpha(0.25),
   weakGroupReplyDeltaThreshold(0.0),
...
bool SearchParams::operator==(const SearchParams& other) const {
  return (
    ...
    weakGroupUtilityLambda == other.weakGroupUtilityLambda &&
    weakGroupReplyBlendWeight == other.weakGroupReplyBlendWeight &&
    weakGroupReplyMode == other.weakGroupReplyMode &&
    weakGroupReplyAlpha == other.weakGroupReplyAlpha &&
    weakGroupReplyDeltaThreshold == other.weakGroupReplyDeltaThreshold &&
...
json SearchParams::changeableParametersToJson() const {
  ...
  ret["weakGroupUtilityLambda"] = weakGroupUtilityLambda;
  ret["weakGroupReplyBlendWeight"] = weakGroupReplyBlendWeight;
  ret["weakGroupReplyMode"] = weakGroupReplyMode;
  ret["weakGroupReplyAlpha"] = weakGroupReplyAlpha;
  ret["weakGroupReplyDeltaThreshold"] = weakGroupReplyDeltaThreshold;
