...
struct WeakGroupHeadDesc {
  ...
  WeakGroupHeadDesc();
  ~WeakGroupHeadDesc();
  WeakGroupHeadDesc(std::istream& in, int modelVersion, bool binaryFloats);
  WeakGroupHeadDesc(WeakGroupHeadDesc&& other);

  WeakGroupHeadDesc(const WeakGroupHeadDesc&) = delete;
  WeakGroupHeadDesc& operator=(const WeakGroupHeadDesc&) = delete;

  WeakGroupHeadDesc& operator=(WeakGroupHeadDesc&& other);
...
struct ModelDesc {
  ...
  // Custom v17 model option D.
  // false: stock model, no WG data follows valueHead.
  // true: Dual-WG WeakGroupHeadDesc follows valueHead.
  bool hasWeakGroupHead;
  WeakGroupHeadDesc weakGroupHead;

  // Custom v17 model option E.
  // false: no WG_REPLY head.
  // true: Dual-WG reply head is stored after WG_NOW.
  bool hasWeakGroupReplyHead;
  WeakGroupHeadDesc weakGroupReplyHead;
